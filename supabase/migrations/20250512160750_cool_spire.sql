/*
  # Add extended product types (physical, affiliate, service, ticket)
  
  1. Changes
     - Update products table type CHECK constraint to include new product types
...
-- Update the product type check constraint to allow new product types
